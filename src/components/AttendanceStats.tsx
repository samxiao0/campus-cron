      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
        <div className="text-center">
          <div className={cn(
            ...
            <span className={cn("text-sm sm:text-xl font-bold", getPercentageColor(stats.percentage))}>
        ...
        <div className="text-center">
          <div className={cn(
            ...
            <span className={cn("text-sm sm:text-xl font-bold", getPercentageColor(stats.monthlyPercentage))}>
        ...
        <div className="text-center">
          ...
          <p className="text-sm sm:text-xl font-bold text-foreground">{stats.totalClasses}</p>
        ...
        <div className="text-center">
          ...
          <p className="text-sm sm:text-xl font-bold text-foreground">{stats.presentClasses}</p>
